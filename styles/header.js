...
export const headerClass = {
    ...
    logo:
        'flex items-center justify-self-start cursor-pointer md:mr-auto ' +
        'text-black dark:text-neutralDark-50',
    search:
        'flex items-center justify-center col-span-2 md:col-span-1 ' +
        'md:justify-items-start',
    user:
        'flex space-x-2 items-center justify-self-end whitespace-nowrap ' +
