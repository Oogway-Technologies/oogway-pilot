...
export const profileCard = {
    ...
    joinedAndLocationText:
        'text-neutral-700 dark:text-neutralDark-300 flex item-center \
        font-normal text-sm md:text-base leading-6 tracking-normal text-gray-600 pt-1',
    bioText:
        'text-neutral-700 dark:text-neutralDark-150 font-normal text-sm md:text-base \
