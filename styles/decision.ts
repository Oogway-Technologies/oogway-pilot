...
export const bigContainer =
    'grid grid-cols-4 gap-5 bg-white rounded-2xl shadow-md dark:bg-neutralDark-500 dark:shadow-black/60 overflow-auto'
...
export const optionRatingTab = {
    ...
    itemContainer:
        ' w-full flex items-center justify-center transition-all border-b-2 border-transparent cursor-pointer ',
}
