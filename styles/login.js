export const loginButtons = {
    ...
    uploadImage:
        'inline-flex text-primary space-x-xs md:space-x-sm cursor-pointer',
    removeImage: 'inline-flex space-x-xs md:space-x-sm',
    checkbox:
...
export const loginInputs = {
    inputHeader:
        'flex outline-0 mb-2 mt-5 text-sm text-neutral-700 dark:text-neutralDark-50 mr-auto',
    inputBorder:
        'inline-flex items-center w-full border-solid \
...
export const privacyDivs = {
    ...
    subheading: 'flex items-start justify-start text-1xl font-bold leading-normal mt-4 mb-3 text-primary',
    paragraph: 'flex items-start justify-start leading-normal mb-3 mt-1',
    paragraphBold: 'flex items-start justify-start leading-normal mb-3 font-bold mt-1',
    divider: 'mb-4',
