export const loginButtons = {
  loginButtonStyle:
    ...
    md:space-x-2 border-solid border-transparent text-neutral-700 dark:text-neutralDark-150 \
    bg-primary text-white hover:font-bold active:font-bold dark:hover:font-bold \
    dark:active:font-bold hover:text-black hover:bg-neutral-50 dark:hover:bg-neutralDark-300 \
    active:bg-primary/20 dark:active:bg-primaryDark/20 hover:text-neutral-700 \
    dark:hover:text-neutralDark-150 active:text-primary dark:active:text-primaryDark",
  cancelButtonStyle:
...
export const loginInputs = {
  inputHeader: "flex outline-0 mb-2 mt-5 text-base text-neutral-800 mr-auto",
  inputBorder:
    "inline-flex items-center w-full lg:w-128 border-solid \
    border-[1px] border-neutral-300 focus-within:border-primary \
