...
export const inputStyle =
    'py-3 px-4 w-full text-sm bg-white dark:bg-neutralDark-500 rounded-lg border-[1px] border-neutral-300 focus-within:border-primary focus:border-primary focus-visible:border-primary active:border-neutral-300 border-solid focus:outline-none dark:focus-within:border-primaryDark dark:focus:border-primaryDark dark:focus-visible:border-primaryDark'
...
export const AiBox =
    'absolute top-[7px] right-[8px] p-2 w-fit text-xs not-italic font-normal leading-4 text-white bg-[#FF7A03] rounded'
